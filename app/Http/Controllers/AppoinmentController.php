...
class AppoinmentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->section->title = 'Appoinments';
        $this->section->heading = 'Appoinments';
        $this->section->slug = 'appoinments';
        $this->section->folder = 'appoinments';
    }
    public function index()
    {
        ...
        $appoinments = Appoinment::with(['service', 'user'])->get();
        ...
        return view($section->folder.'.index',compact('section', 'appoinments', 'html', 'todayDate'));
    }
