...
// =====================================================================
    ...
    if (!function_exists('checkStreamPurchase')) {
        function checkStreamPurchase($streamId)
        {
            $checkPurchase = \App\Models\Payment::where('stream_id', $streamId)->where('user_id', auth()->user()->id)->get();
