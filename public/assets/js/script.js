...
if($('#dataexp').length>0){$('#dataexp').DataTable({"bFilter":true,"sDom":'fBtlpi','pagingType':'numbers',"ordering":true,"language":{search:' ',sLengthMenu:'_MENU_',searchPlaceholder:"Search...",info:"_START_ - _END_ of _TOTAL_ items",},initComplete:(settings,json)=>{$('.dataTables_filter').appendTo('#tableSearch');$('.dataTables_filter').appendTo('.search-input');},"order": [[4, 'asc']]});}
...
'<li class="sidebar-icons">'+
'<a href="#" class="add-setting" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">Icon 1</a>'+
'</li>'+
'<li class="sidebar-icons">'+
'<a href="#" class="navigation-add" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">Icon 2</a>'+
'</li>'+
'<li class="sidebar-icons">'+
'<a href="https://themeforest.net/item/dreamspos-pos-inventory-management-admin-dashboard-template/38834413" target="_blank" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">icon 1 </a>'+
'</li>'+
'</ul>'+
'</div>'+
...
'<a class="sidebar-close" href="#">Close</a>'+
'</div>'+
'<div class="sidebar-body">'+
'<h6 class="theme-title">Choose Mode</h6>'+
'<div class="switch-wrapper">'+
'<div id="dark-mode-toggle">'+
'<span class="light-mode active"> Light</span>'+
...
'</div>'+
'<div class="layout-img">layout4</div>'+
'</div>'+
'</div>'+
'<div class="col-xl-6 ere">'+
'<div class="layout-wrap">'+
...
'</div>'+
'<div class="layout-img">layout-01</div>'+
'</div>'+
'</div>'+
'</div>'+
'</div>'+
...
'<a class="sidebar-close" href="#">close-icon</a>'+
'</div>'+
'<div class="sidebar-body">'+
...
'</div>'+
'<div class="layout-img">layout-03</div>'+
'</div>'+
'</div>'+
'<div class="col-xl-6 ere">'+
'<div class="layout-wrap">'+
...
'</div>'+
'<div class="layout-img">layout-04</div>'+
'</div>'+
'</div>'+
'<div class="col-xl-6 ere">'+
'<div class="layout-wrap">'+
