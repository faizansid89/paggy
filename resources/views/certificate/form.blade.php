                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('webinar.certificate') }}">{{ $section->heading }}</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::model($certificates, ['route' => $section->route, 'class' => 'form-validate', 'files' => true, 'enctype' => 'multipart/form-data', 'autocomplete' => 'off']) !!}
