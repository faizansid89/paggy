...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            @if((in_array('create-webinar', getUserPermissions())))
            <div class="page-btn">
                <a href="{{ route('webinar.create') }}" class="btn btn-added"><img src="{{ asset('assets/img/icons/plus.svg') }}" class="me-2" alt="img"> Add New {{ $section->heading }}</a>
            </div>
                @endif
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table datanew">
                                ...
                                <tr>
                                    ...
                                    <th>Related To</th>
                                    <th>Buy Now</th>
                                    @if((in_array('update-webinar', getUserPermissions())))
                                        <th>Status</th>
                                        <th>Action</th>
                                    @endif
                                </tr>
                                        ...
                                        @foreach( $web as $live )
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endphp
                                                    @if((in_array('purchase-webinar', getUserPermissions())))
                                                        @if(checkWebinarPurchase($live->id) < 1)
                                                ...
                                                @if((in_array('update-webinar', getUserPermissions())))
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            @if((in_array('update-webinar', getUserPermissions())))
                                                                <a  type="button" class="btn btn-danger" href="{{ route("webinar.edit", $live->id) }}" style="color: #ffffff;">
                                                                    Edit
                                                                </a>
                                                            @endif
                                                        </div>
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        {!! Form::model($web, ['route' => 'webinar.buy', 'class' => 'form-validate require-validation', 'files' => true, 'enctype' => 'multipart/form-data', 'autocomplete' => 'off', 'data-cc-on-file' => 'false', 'data-stripe-publishable-key' => env('STRIPE_SECRET_KEY')]) !!}
        @method('POST')
                    ...
                    <div class="col-lg-12 float-md-right">
                        <div class="total-order mt-0">
                            ...
                            <ul>
                                ...
                                {!! Form::hidden('niche', 'webinar', ['class' => 'mb-2 form-control']) !!}
