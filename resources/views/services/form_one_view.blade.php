                            ...
                            <div class="form-row row">
                               ...
                               <div class="col-md-4 mb-3">
                                   <div class="form-group">
                                       ...
                                       <div class="form-check form-check-inline"> <input class="form-check-input" type="radio" name="ok_to_number" id="flexRadioDefault1" checked="">
                                           <label class="form-check-label" for="flexRadioDefault1"> {{ $formData->ok_to_number }} </label>
                                       </div>
                               ...
                               <div class="col-md-4 mb-3">
                                   <div class="form-group">
                                       ...
                                       <div class="form-check form-check-inline"> <input class="form-check-input" type="radio" name="ok_to_email" id="emailSendYes" checked="">
                                        <label class="form-check-label" for="emailSendYes"> {{ $formData->ok_to_email }} </label>
                                       </div>
                                       <!--<div class="form-check form-check-inline">-->
                           ...
                           <div class="form-row row">
                               ...
                               <div class="col-md-4 mb-3">
                                  <div class="form-group">
                                     ...
                                     <div class="form-check"> <input class="form-check-input" type="radio" value="Male" name="gender" id="Male" checked="">
                                        <label class="form-check-label" for="Male">{{ $formData->gender }}</label>
                               ...
                               <div class="col-md-4 mb-3">
                                  <div class="form-group">
                                     ...
                                     <div class="form-check"> <input class="form-check-input" type="radio" name="relationship_status" value="Single" id="Single" checked="">
                                        <label class="form-check-label" for="Single">{{ $formData->relationship_status }}</label>
                                     </div>
                                     <!--<div class="form-check">-->
                               ...
                               <div class="col-md-4 mb-3">
                                  <div class="form-group">
                                     ...
                                     <div class="form-check "> <input class="form-check-input" type="radio" name="sexual_orientation" value="Straight/heterosexual" id="Straight/heterosexual" checked="">
                                        <label class="form-check-label" for="Straight/heterosexual">{{ $formData->sexual_orientation }}</label>
                                     </div>
                                     <!--<div class="form-check ">-->
                               ...
                               <div class="col-md-2 mb-3">
                                  <div class="form-group">
                                     ...
                                     <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="PronounsHe/him">{{ $formData->pronouns }}</label>
                                     </div>
                                     <!--<div class="form-check">-->
                               ...
                               <div class="col-md-3 mb-3">
                                   <div class="form-group">
                                       ...
                                       <div class="form-check form-check-inline"> <input class="form-check-input" type="radio" name="previous_marriages" value="yes" id="PreviousmarriagesYes" checked="">
                                           <label class="form-check-label" for="PreviousmarriagesYes"> {{ $formData->previous_marriages }} </label>
                                       </div>
                                       <!--<div class="form-check form-check-inline">-->
                            ...
                            <div class="form-row row">
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        <label>Sex/Gender:</label>
                                        <div class="form-check form-check-inline"> <input class="form-check-input" type="radio" name="household_gender" value="male" id="HouseHoldMale" checked="">
                                            <label class="form-check-label" for="HouseHoldMale">{{ $formData->household_gender }}</label>
                                        </div>
                                        <!--<div class="form-check form-check-inline">-->
                            ...
                            <div class="form-row row">
                                <div class="col-md-3 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline"> 
                                            <input class="form-check-input" type="radio" name="abusive_relationship" id="abusiveRelationshipYes" value="yes" checked="">
                                            <label class="form-check-label" for="abusiveRelationshipYes"> {{ $formData->abusive_relationship }} </label>
                                        </div>
                                        <!--<div class="form-check form-check-inline">-->
                                ...
                                <div class="col-md-3 mb-3 relationshipAbuseFeilds hidden">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check"> 
                                            ...
                                            <label class="form-check-label" for="OccurDaily">{{ $formData->abusive_relationship_occur }}</label>
                                        </div>
                                        <!--<div class="form-check">-->
                            ...
                            <div class="form-row row relationshipAbusiveCustom">
                                <div class="col-md-4 mb-3">
                                     <div class="form-group">
                                         ...
                                         <div class="form-check form-check-inline"> <input class="form-check-input" type="radio" name="past_relationships_abusive" value="yes" id="relationshipsAbusiveYes" checked="">
                                             <label class="form-check-label" for="relationshipsAbusiveYes">{{ $formData->past_relationships_abusive }}</label>
                                         </div>
                                         <!--<div class="form-check form-check-inline">-->
                                ...
                                <div class="form-row row CustomSexuallyViolatedAssaulted">
                                    <div class="col-md-4 mb-3">
                                         <div class="form-group">
                                             ...
                                             <div class="form-check form-check-inline"> <input class="form-check-input" type="radio" name="sexually_violated_assaulted" value="yes" id="SexuallyViolatedAssaultedYes" checked="">
                                                 <label class="form-check-label" for="SexuallyViolatedAssaultedYes">{{ $formData->sexually_violated_assaulted }}</label>
                                             </div>
                                             <!--<div class="form-check form-check-inline">-->
                                ...
                                <div class="form-row row">
                                    <div class="col-md-4 mb-3">
                                         <div class="form-group">
                                             ...
                                             <div class="form-check form-check-inline"> 
                                                <input class="form-check-input" value="yes" type="radio" name="sexually_assaulted_raped" id="CustomAdultRapedYes" checked="">
                                                 <label class="form-check-label" for="CustomAdultRapedYes">{{ $formData->sexually_assaulted_raped }}</label>
                                             </div>
                                             <!--<div class="form-check form-check-inline">-->
                            ...
                            <div class="form-row row">
                                <div class="col-md-3 mb-3">
                                     <div class="form-group">
                                         ...
                                         <div class="form-check form-check-inline"> <input class="form-check-input" type="radio" value="yes" name="receiving_therapy_any_one" id="CustomReceivingTherapyYes" checked="">
                                             <label class="form-check-label" for="CustomReceivingTherapyYes">{{ $formData->receiving_therapy_any_one }}</label>
                                         </div>
                                         <!--<div class="form-check form-check-inline">-->
                            ...
                            <div class="form-row row">
                                <div class="col-md-3 mb-3">
                                     <div class="form-group">
                                         ...
                                         <div class="form-check form-check-inline"> <input class="form-check-input" type="radio" name="counseling_services" value="yes" id="CounselingServicesYes" checked="">
                                             <label class="form-check-label" for="CounselingServicesYes">{{ $formData->counseling_services }}</label>
                                         </div>
                                         <!--<div class="form-check form-check-inline">-->
                                 ...
                                 <div class="col-md-3 mb-3 CounselingServicesFields hidden dflex">
                            ...
                            <div class="form-row row">
                                ...
                                <div class="col-md-4 mb-3">
                                     <div class="form-group">
                                         ...
                                         <div class="form-check form-check-inline"> 
                                            <input class="form-check-input" type="radio" value="yes" name="hospitalized_child_birth" id="ChildBirthYes" checked="">
                                             <label class="form-check-label" for="ChildBirthYes">{{ $formData->hospitalized_child_birth }}</label>
                                         </div>
                                         <!--<div class="form-check form-check-inline">-->
                                 ...
                                 <div class="col-md-12 mb-3">
                                     <div class="form-group">
                                         ...
                                         <div class="form-check form-check-inline"> <input class="form-check-input" type="radio" value="yes" name="hospitalized_mental_health" id="HospitalizedYes" checked="">
                                             <label class="form-check-label" for="HospitalizedYes">{{ $formData->hospitalized_mental_health }}</label>
                                         </div>
                                         <!--<div class="form-check form-check-inline">-->
                                 ...
                                 <div class="col-md-4 mb-3">
                                     <div class="form-group">
                                         ...
                                         <div class="form-check form-check-inline"> 
                                            <input class="form-check-input" value="yes" type="radio" name="alcohol_usaged" id="radioAlcoholUsagedYes" checked="">
                                             <label class="form-check-label" for="radioAlcoholUsagedYes">{{ $formData->alcohol_usaged }}</label>
                                         </div>
                                         <!--<div class="form-check form-check-inline">-->
                             ...
                             <div class="form-row row">
                                 <div class="col-md-4 mb-3">
                                     <div class="form-group">
                                         ...
                                         <div class="form-check form-check-inline"> 
                                            <input class="form-check-input" value="yes" type="radio" name="family_alcohol_usaged" id="radioFamilyAlcoholUsagedYes" checked="">
                                             <label class="form-check-label" for="radioFamilyAlcoholUsagedYes">{{ $formData->family_alcohol_usaged }}</label>
                                         </div>
                                         <!--<div class="form-check form-check-inline">-->
                                ...
                                <div class="form-row row">
                                 <div class="col-md-3 mb-3">
                                     <div class="form-group">
                                         ...
                                         <div class="form-check form-check-inline"> 
                                            <input class="form-check-input" value="yes" type="radio" name="prescription_medications" id="radioPrescriptionMedicationsYes" checked="">
                                             <label class="form-check-label" for="radioPrescriptionMedicationsYes">{{ $formData->prescription_medications }}</label>
                                         </div>
                                         <!--<div class="form-check form-check-inline">-->
                            ...
                            <div class="form-row row">
                                <div class="col-md-4 mb-3 threegoals">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">1</span>
                                        <label class="form">{{ $formData->primary_goal_one }}</label>
                                ...
                                <div class="col-md-4 mb-3 threegoals">
                                    <div class="input-group mb-3">
                                        ...
                                        <label class="form">{{ $formData->primary_goal_two }}</label>
                                ...
                                <div class="col-md-4 mb-3 threegoals">
                                    <div class="input-group mb-3">
                                        ...
                                        <label class="form">{{ $formData->primary_goal_three }}</label>
